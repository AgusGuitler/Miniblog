...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Agus\Desktop\python y flask\tutorialFlask\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Agus\Desktop\python y flask\tutorialFlask\env\Scripts\deactivate.nu'
